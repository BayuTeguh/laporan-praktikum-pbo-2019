...
public class TestRunner1841720207Bayu {
    
    public static void main(String[] args) {
        Result mResult = new JUnitCore().runClasses(MessageProcessor1841720207BayuTest.class);
        showMessageResult(mResult, MessageProcessor1841720207BayuTest.class.getSimpleName());
    }
